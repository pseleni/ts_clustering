...
# # datasets = ['LargeKitchenAppliances', ]
...
#         with open('results/'+data+'_'+metric +'_preprocessed.csv', 'a') as csvfile:
#             writer = csv.writer(csvfile)
#             writer.writerow(header)
#             writer.writerow(run_kmeans(data, 4, metric))
#             csvfile.close()
#         with open('results/'+data+'_'+metric+'.csv', 'a') as csvfile:
#             writer = csv.writer(csvfile)
#             writer.writerow(header)
#             writer.writerow(run_kmeans_without(data, 4, metric))
#             csvfile.close()
...
# #             writer.writerow(run_kmeans(data, 4, metric))
# #             csvfile.close()
#         with open('old/results/'+data+'_'+metric+'.csv', 'a') as csvfile:
#             writer = csv.writer(csvfile)
#             writer.writerow(header)
#             writer.writerow(run_kmeans_without(data, 4, metric))
#             csvfile.close()
